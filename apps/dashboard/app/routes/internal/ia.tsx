...
/** ダッシュボード情報設計（ワイヤー）— 認証なしで閲覧可（必要なら後で塞ぐ） */
          ...
          <table className="w-full min-w-[36rem] border-separate border-spacing-0 text-left text-sm">
            ...
            <tbody className="text-zinc-300">
              ...
              <tr className="border-b border-zinc-800/80">
                ...
                <td className="py-3 text-zinc-500">組織は admin/owner のみ選択可</td>
              </tr>
              <tr className="border-b border-zinc-800/80">
                <td className="py-3 pr-4 font-mono text-xs text-amber-200/90">
                  /p/:id
              ...
              <tr className="border-b border-zinc-800/80">
                ...
                <td className="py-3 text-zinc-500">link / email</td>
              </tr>
              <tr className="border-b border-zinc-800/80">
                <td className="py-3 pr-4 font-mono text-xs text-amber-200/90">
                  /logout
              ...
              <tr className="border-b border-zinc-800/80">
                ...
                <td className="py-3 text-zinc-500">GET ?id=&amp;next=</td>
              </tr>
              <tr className="border-b border-zinc-800/80">
                <td className="py-3 pr-4 font-mono text-xs text-amber-200/90">
                ...
                <td className="py-3 text-zinc-500">プレースホルダー</td>
              </tr>
            </tbody>
          </table>
        </Card>
