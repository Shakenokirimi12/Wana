/* eslint-disable */
// Generated by Wrangler by running `wrangler types --env-interface CloudflareBindings` (hash: ab98c70b7fe499f019e85051737eed0b)
// Runtime types generated with workerd@1.20260430.1 2026-05-02 nodejs_compat
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./src/index");
		durableNamespaces: "ProjectDataStore";
	}
	interface Env {
		SYSTEM_CONFIG: KVNamespace;
		PAYLOAD_STORAGE: R2Bucket;
		PROJECT_DO: DurableObjectNamespace<import("./src/index").ProjectDataStore>;
	}
}
